...
const deliverables = [
  { icon: Image, label: "Social Media Creatives (Instagram, Facebook, LinkedIn)" },
  { icon: Megaphone, label: "Ad Creatives (Meta, Google Display)" },
  { icon: Globe, label: "Website Graphics & Banners" },
  { icon: FileText, label: "Marketing Collateral (Flyers, Brochures)" },
  { icon: Presentation, label: "Presentation Design" },
  { icon: Film, label: "Thumbnail & Visual Assets" },
  { icon: Compass, label: "Creative Direction for Campaigns" },
];

const processSteps = [
  { icon: Search, step: "01", title: "Requirement Understanding", text: "We align with your campaign goals and audience." },
  { icon: Palette, step: "02", title: "Concept & Direction", text: "We create design directions based on your brand and objective." },
  { icon: Paintbrush, step: "03", title: "Creative Design", text: "We design visually engaging and high-converting creatives." },
  { icon: MessageSquare, step: "04", title: "Feedback & Iteration", text: "We refine designs based on your feedback." },
  { icon: Send, step: "05", title: "Final Delivery", text: "Ready-to-use creatives optimized for each platform." },
];

const whyChoose = [
  { icon: Target, title: "Performance-Driven Design", text: "Every design is built to drive engagement and results." },
  { icon: Megaphone, title: "Built for Ads & Conversions", text: "Designs optimized for ad performance across platforms." },
  { icon: Zap, title: "Fast Delivery", text: "Quick turnaround for ongoing campaigns." },
  { icon: Layers, title: "Consistent Brand Visuals", text: "Maintain brand consistency across all platforms." },
  { icon: Rocket, title: "Ideal for Growing Businesses", text: "Scalable solutions for startups and growing brands." },
];

const whoItsFor = [
  { icon: DollarSign, label: "Businesses running paid ads" },
  { icon: Share2, label: "Brands active on social media" },
  { icon: Building2, label: "Companies needing marketing creatives" },
  { icon: Sparkles, label: "Startups building visual identity" },
];

export default function GraphicDesignSections() {
  return (
    <>
      {/* ═══════════ SERVICE OVERVIEW ═══════════ */}
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <motion.div {...fadeUp()} className="glass-card">
            <div className="max-w-3xl mx-auto text-center">
              <span className="inline-block mb-5 rounded-full border border-gray-300/60 bg-white px-4 py-1.5 text-xs font-semibold text-gray-600">Visual Design</span>
              <h2 className="text-gray-900">Strategic Visuals That Get Results</h2>
              <p className="mt-6 text-[16px] sm:text-lg leading-relaxed text-gray-600">
                In today&apos;s fast-moving digital world, visuals play a critical role in grabbing attention and influencing decisions. Generic designs get ignored — strategic, high-quality visuals get results.
              </p>
              <p className="mt-4 text-[16px] sm:text-lg leading-relaxed text-gray-700 font-medium">
                At CleverCrow, we design creatives that are not just visually appealing but built for marketing performance across platforms.
              </p>
              <div className="mt-8 flex flex-wrap justify-center gap-2.5">
                {["High-Impact Creatives", "Ad-Optimized", "Brand Consistency", "Fast Turnaround"].map((pill, i) => (
      ...
      <section className="relative py-24 sm:py-32 bg-[#fafafa] overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <motion.div {...fadeUp()} className="text-center mb-16">
            ...
            <h2 className="text-gray-950">Design Services We Provide</h2>
          </motion.div>
      ...
      <section id="process" className="relative py-24 sm:py-32 bg-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <motion.div {...fadeUp()} className="text-center mb-16">
            ...
            <h2 className="text-gray-950">Our Graphic Design Process</h2>
          </motion.div>
      ...
      <section className="relative py-24 sm:py-32 bg-neutral-950 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <motion.div {...fadeUp()} className="text-center mb-16">
            ...
            <h2 className="text-white">Why CleverCrow for Graphic Design</h2>
          </motion.div>
      ...
      <section className="relative bg-neutral-950 py-24 sm:py-32 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          <motion.div {...fadeUp()}>
            <span className="inline-flex items-center rounded-full bg-white/5 px-4 py-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-blue-500 border border-white/10 mb-6">Get Started</span>
          </motion.div>
          <motion.h2 {...fadeUp(0.1)} className="text-white">Ready to Elevate Your Brand Visuals?</motion.h2>
          <motion.p {...fadeUp(0.15)} className="mx-auto mt-6 max-w-2xl text-lg text-neutral-400 leading-relaxed">Let&apos;s create designs that grab attention and convert.</motion.p>
